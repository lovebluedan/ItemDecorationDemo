...
public class DecorationMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case R.id.btn_divider:
                Intent intent = new Intent(DecorationMainActivity.this,DividerActivity.class);
                startActivity(intent);

                break;
            case R.id.btn_divider1:
                Intent intent1 = new Intent(DecorationMainActivity.this,ColorDividerActivity.class);
                startActivity(intent1);

                break;
            case R.id.btn_divider2:
                Intent intent2 = new Intent(DecorationMainActivity.this,TimelineActivity.class);
                startActivity(intent2);

                break;
            case R.id.btn_divider3:
                Intent intent3 = new Intent(DecorationMainActivity.this,BookRankActivity.class);
                startActivity(intent3);

                break;
            case R.id.btn_divider4:
                Intent intent4 = new Intent(DecorationMainActivity.this,HeaderActivity.class);
                startActivity(intent4);
                break;
            case R.id.btn_divider5:
                Intent intent5 = new Intent(DecorationMainActivity.this,StickyHeaderActivity.class);
